...
Write-Log "Start script AIBCustomiser_JoinDomain v0.1"

$user = "gundel\administrator"
$password = "WmRules3" | ConvertTo-SecureString -AsPlainText -Force
$credential = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $user, $password
Add-Computer -Credential $credential -DomainName gundel.local -OUPath "OU=BuildOU,DC=gundel,DC=local"
